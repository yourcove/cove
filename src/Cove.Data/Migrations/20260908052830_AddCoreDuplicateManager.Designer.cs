...
namespace Cove.Data.Migrations
{
    ...
    [Migration("20260908052830_AddCoreDuplicateManager")]
    partial class AddCoreDuplicateManager
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cove.Core.Entities.DuplicateSearch", b =>
                {
                    ...
                    b.Property<string>("FolderPathsJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValue("[]");
                    ...
                    b.Property<string>("KeeperRulesJson")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValue("[\"resolution\",\"codec\",\"bitrate\",\"duration\",\"metadata\",\"oldest\"]");
                    ...
                    b.Property<string>("PreferredCodecsJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValue("[\"av1\",\"hevc\",\"h264\",\"vp9\",\"mpeg4\"]");
            ...
            modelBuilder.Entity("Cove.Core.Entities.DuplicateSearchGroup", b =>
                {
                    ...
                    b.Property<int?>("RecommendedVideoId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Cove.Core.Entities.ImageDuplicateKeeperReservation", b =>
                {
                    b.Property<Guid>("SearchId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("SearchId", "FileId");

                    b.HasIndex("FileId");

                    b.HasIndex("ImageId");

                    b.ToTable("image_duplicate_keeper_reservations", (string)null);
                });

            modelBuilder.Entity("Cove.Core.Entities.ImageDuplicateSearch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("CleanupJobId")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
                    ...
                    b.ToTable("image_duplicate_searches", (string)null);
                });

            modelBuilder.Entity("Cove.Core.Entities.ImageDuplicateSearchGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("image_duplicate_search_groups", (string)null);
                });

            modelBuilder.Entity("Cove.Core.Entities.ImageDuplicateSearchItem", b =>
                {
                    b.Property<int>("GroupId")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("image_duplicate_search_items", (string)null);
                });
            ...
            modelBuilder.Entity("Cove.Core.Entities.ImageDuplicateKeeperReservation", b =>
                {
                    b.HasOne("Cove.Core.Entities.ImageFile", "File")
                        .WithMany()
                        .HasForeignKey("FileId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("Cove.Core.Entities.ImageDuplicateSearch", "Search")
                        .WithMany("KeeperReservations")
                        .HasForeignKey("SearchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Cove.Core.Entities.ImageDuplicateSearchItem", b =>
                {
                    ...
                    b.HasOne("Cove.Core.Entities.ImageDuplicateSearchGroup", "Group")
                        .WithMany("Items")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
