...
public class MultiIdCriterion { public List<int> Value { get; set; } = []; public CriterionModifier Modifier { get; set; } = CriterionModifier.Includes; public List<int>? Excludes { get; set; } public List<int>? RequiredIds { get; set; } public int? Depth { get; set; } }
