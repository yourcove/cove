...
Start with the record that owns the content, then add only the relationships that improve retrieval:

- [performers](../../../reference/performers/) and [studios](../../../reference/studios/) for identities reused across items
- [tags](../../../reference/tags/) for overlapping classification
- tag groups for keeping a larger tag vocabulary divided into understandable categories
- [groups](../../../reference/groups/) for a collection with its own identity or order
- [saved filters](../../../reference/saved-filters/) for a view you want to revisit
- [dynamic groups](../../../reference/dynamic-groups/) when a library collection should resolve from a query
...
See [Groups](../../../reference/groups/), [dynamic groups](../../../reference/dynamic-groups/), and [saved filters](../../../reference/saved-filters/) for their record and lifecycle boundaries.
