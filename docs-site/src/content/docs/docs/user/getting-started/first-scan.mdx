...
<DocsScreenshot
  src="images/docs/thumbnails/first-scan-options.webp"
...
- **A moved, replaced, or unchanged file was skipped:** select only its folder and retry with **Force rescan (ignore mtime)**. This is especially important after editing or replacing file bytes in place. Do not force-rescan the whole library unless it is necessary. See [Scans](../../../reference/scans/) for file identity, interrupted-copy handling, and unchanged-directory verification.
