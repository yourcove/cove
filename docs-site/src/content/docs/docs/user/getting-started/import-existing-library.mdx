...
compatibility:
  sources:
    - src/Cove.Api/Controllers/StashMigrationController.cs
    - src/Cove.Api/Services/StashMigrationService.cs
    - src/Cove.Api/Controllers/MetadataController.cs
---
...
4. For Docker, add read-only mounts before starting Cove. For example:
   ...
   You would then enter `/stash/stash-go.sqlite`, not the host path, in the wizard.
