...
For user-facing changes, use [Cove design principles and guidelines](../../design-guidelines/) when planning the default workflow, advanced capabilities, state changes, and recovery.
