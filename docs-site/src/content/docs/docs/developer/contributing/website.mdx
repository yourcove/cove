...
The primary navigation follows three reader destinations:

| Section | Reader intent | Content |
| --- | --- | --- |
| Tutorial | Learn by completing a guided experience | Tutorials only |
| Guide | Accomplish a task or understand a design | How-to guides and explanations |
| Reference | Look up exact behavior | Reference pages and terminology |

Organize by purpose before audience. User and developer material can both belong in Tutorial or Guide, while shared contracts and product concepts belong in Reference. Existing page URLs do not need to mirror the navigation hierarchy.
