...
The [Terminology reference](../../../terminology/) is the canonical short definition of Cove-specific concepts.
...
When a concept needs more than one sentence to teach, keep its terminology entry concise and create an explanation page for the fuller mental model.
