...
| `minCoveVersion` | Any Cove version | Minimum running Cove version. An installer rejects a package when it can parse both versions and the running version is lower. |
