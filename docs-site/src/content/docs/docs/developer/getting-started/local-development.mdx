...
The backend build output also reports the derived Cove version. On a commit two steps after `v1.1.0`, expect `1.1.1-dev.2`; an exact release-tag checkout reports `1.1.0`.
