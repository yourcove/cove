...
const NON_NULL_NUMBER_MODIFIERS: CriterionModifier[] = [
  "EQUALS",
  "NOT_EQUALS",
  "GREATER_THAN",
  "LESS_THAN",
...
const NON_NULL_TIMESTAMP_MODIFIERS: CriterionModifier[] = [
  "EQUALS",
  "NOT_EQUALS",
  "GREATER_THAN",
  "LESS_THAN",
...
export const VIDEO_CRITERIA: CriteriaDefinitionList<VideoFilterCriteria> = [
  ...
  { id: "resolution", label: "Resolution", type: "resolution", filterKey: "resolutionCriterion" },
  {
    ...
    label: "Play Count",
    type: "number",
    filterKey: "playCountCriterion",
    modifiers: NON_NULL_NUMBER_MODIFIERS,
  },
  {
    id: "performerCount",
    label: "Performer Count",
    type: "number",
    filterKey: "performerCountCriterion",
    modifiers: NON_NULL_NUMBER_MODIFIERS,
  },
  {
    id: "tagCount",
  ...
  },
  {
    ...
    type: "multiId",
    entityType: "studios",
    filterKey: "studiosCriterion",
    hierarchyToggleLabel: "Include sub-studios",
  },
  ...
  {
    id: "remoteIdCount",
    label: "Remote ID Count",
    type: "number",
    filterKey: "remoteIdCountCriterion",
    modifiers: NON_NULL_NUMBER_MODIFIERS,
  },
  ...
  },
  {
    ...
    relatedCriteria: () => getRelatedCriteria("performers"),
    relatedContextCriteria: [
      {
        id: "specificPerformer",
        label: "Specific Performer",
        type: "multiId",
        entityType: "performers",
        filterKey: "performerIdsCriterion",
        modifiers: ["INCLUDES", "EXCLUDES"],
      },
      { id: "ageAtVideoDate", label: "Age (then)", type: "number", filterKey: "ageAtHostDateCriterion" },
      {
        id: "performerOccurrenceTags",
        label: "Occurrence Tags",
        type: "multiId",
        entityType: "tags",
        filterKey: "performerOccurrenceTagsCriterion",
      },
    ],
  },
  ...
  { id: "updatedAt", label: "Updated At", type: "timestamp", filterKey: "updatedAtCriterion" },
  {
    ...
    type: "multiId",
    entityType: "tags",
    filterKey: "performerTagsCriterion",
  },
  ...
  { id: "captions", label: "Captions", type: "string", filterKey: "captionsCriterion" },
  {
    ...
    modifiers: VALUE_ONLY_ENUM_MODIFIERS,
    options: [
...
export const PERFORMER_CRITERIA: CriteriaDefinitionList<PerformerFilterCriteria> = [
  ...
  { id: "favorite", label: "Favorite", type: "bool", filterKey: "favoriteCriterion" },
  {
    ...
    category: "related",
    relatedCriteria: () => getRelatedCriteria("videos"),
  },
  {
    id: "relatedAudios",
    ...
    category: "related",
    supportsDistinctSiblingMatches: true,
    relatedCriteria: () => getRelatedCriteria("audios"),
  },
  ...
  },
  {
    ...
    label: "Studio Count",
    type: "number",
    filterKey: "studioCountCriterion",
    modifiers: NON_NULL_NUMBER_MODIFIERS,
  },
  {
    id: "imageCount",
  ...
  },
  {
    ...
    label: "Gallery Count",
    type: "number",
    filterKey: "galleryCountCriterion",
    modifiers: NON_NULL_NUMBER_MODIFIERS,
  },
  ...
  { id: "url", label: "URL", type: "string", filterKey: "urlCriterion" },
  {
    ...
    label: "Created At",
    type: "timestamp",
    filterKey: "createdAtCriterion",
    modifiers: NON_NULL_TIMESTAMP_MODIFIERS,
  },
  {
    id: "updatedAt",
    label: "Updated At",
    type: "timestamp",
    filterKey: "updatedAtCriterion",
    modifiers: NON_NULL_TIMESTAMP_MODIFIERS,
  },
  ...
  { id: "penisLength", label: "Penis Length", type: "number", filterKey: "penisLengthCriterion" },
  {
    ...
    label: "Circumcised",
    type: "enum",
    filterKey: "circumcisedCriterion",
    options: [
      { value: "Cut", label: "Cut" },
  ...
  },
  {
    ...
    label: "Likes",
    type: "number",
    filterKey: "likeCounterCriterion",
    modifiers: NON_NULL_NUMBER_MODIFIERS,
  },
  { id: "groups", label: "Groups", type: "multiId", entityType: "groups", filterKey: "groupsCriterion" },
  {
...
export const TAG_CRITERIA: CriteriaDefinitionList<TagFilterCriteria> = [
  ...
  { id: "favorite", label: "Favorite", type: "bool", filterKey: "favoriteCriterion" },
  {
    ...
    filterKey: "videoCountCriterion",
    modifiers: NON_NULL_NUMBER_MODIFIERS,
    auxiliaryToggleKey: "videoCountIncludesChildren",
    auxiliaryToggleLabel: "Count videos from child tags",
  },
  {
    id: "performerCount",
    label: "Performer Count",
    ...
    filterKey: "performerCountCriterion",
    modifiers: NON_NULL_NUMBER_MODIFIERS,
    auxiliaryToggleKey: "performerCountIncludesChildren",
    auxiliaryToggleLabel: "Count performers from child tags",
  },
  ...
  { id: "description", label: "Description", type: "string", filterKey: "descriptionCriterion" },
  {
    ...
    filterKey: "imageCountCriterion",
    modifiers: NON_NULL_NUMBER_MODIFIERS,
    auxiliaryToggleKey: "imageCountIncludesChildren",
    auxiliaryToggleLabel: "Count images from child tags",
  },
  {
    id: "galleryCount",
    label: "Gallery Count",
    ...
    filterKey: "galleryCountCriterion",
    modifiers: NON_NULL_NUMBER_MODIFIERS,
    auxiliaryToggleKey: "galleryCountIncludesChildren",
    auxiliaryToggleLabel: "Count galleries from child tags",
  },
  {
    id: "studioCount",
    label: "Studio Count",
    ...
    filterKey: "studioCountCriterion",
    modifiers: NON_NULL_NUMBER_MODIFIERS,
    auxiliaryToggleKey: "studioCountIncludesChildren",
    auxiliaryToggleLabel: "Count studios from child tags",
  },
  {
    id: "groupCount",
    label: "Group Count",
    type: "number",
    filterKey: "groupCountCriterion",
    modifiers: NON_NULL_NUMBER_MODIFIERS,
    auxiliaryToggleKey: "groupCountIncludesChildren",
    auxiliaryToggleLabel: "Count groups from child tags",
  },
  {
    id: "parentCount",
    label: "Parent Count",
    type: "number",
    filterKey: "parentCountCriterion",
    modifiers: NON_NULL_NUMBER_MODIFIERS,
  },
  {
    id: "childCount",
...
export const IMAGE_CRITERIA: CriteriaDefinitionList<ImageFilterCriteria> = [
  ...
  { id: "path", label: "Path", type: "path", filterKey: "pathCriterion" },
  {
    ...
    label: "Hash",
    type: "hash",
    filterKey: "fingerprintCriterion" as Extract<keyof ImageFilterCriteria, string>,
    options: [...VISUAL_HASH_OPTIONS],
  },
  { id: "url", label: "URL", type: "string", filterKey: "urlCriterion" },
  { id: "rating", label: "Rating", type: "rating", filterKey: "ratingCriterion" },
  { id: "favorite", label: "Favorite", type: "bool", filterKey: "favoriteCriterion" },
  ...
  },
  {
    ...
    label: "Performer Age",
    type: "number",
    filterKey: "performerAgeCriterion" as Extract<keyof ImageFilterCriteria, string>,
  },
  {
    id: "orientation",
    label: "Orientation",
    type: "enum",
    filterKey: "orientationCriterion" as Extract<keyof ImageFilterCriteria, string>,
    modifiers: VALUE_ONLY_ENUM_MODIFIERS,
    options: [
      { value: "landscape", label: "Landscape" },
      { value: "portrait", label: "Portrait" },
...
export const AUDIO_CRITERIA: CriteriaDefinitionList<AudioFilterCriteria> = [
  ...
  },
  {
    ...
    label: "Play Duration",
    type: "number",
    filterKey: "playDurationCriterion",
    modifiers: NON_NULL_NUMBER_MODIFIERS,
  },
  { id: "lastPlayedAt", label: "Last Played", type: "timestamp", filterKey: "lastPlayedAtCriterion" },
  {
...
export const GROUP_CRITERIA: CriteriaDefinitionList<GroupFilterCriteria> = [
  ...
  {
    id: "cachedItemCount",
    label: "Cached Item Count",
    type: "number",
    filterKey: "cachedItemCountCriterion",
    modifiers: NON_NULL_NUMBER_MODIFIERS,
  },
  ...
  {
    id: "performerItemCount",
    label: "Performer Item Count",
    type: "number",
    filterKey: "performerItemCountCriterion",
    modifiers: NON_NULL_NUMBER_MODIFIERS,
  },
  {
    id: "studioItemCount",
    label: "Studio Item Count",
    type: "number",
    filterKey: "studioItemCountCriterion",
    modifiers: NON_NULL_NUMBER_MODIFIERS,
  },
  {
    id: "tagItemCount",
    ...
    type: "number",
    filterKey: "tagItemCountCriterion",
    modifiers: NON_NULL_NUMBER_MODIFIERS,
  },
  {
    id: "faceCount",
  ...
  },
  {
    ...
    label: "Segment Count",
    type: "number",
    filterKey: "segmentCountCriterion",
    modifiers: NON_NULL_NUMBER_MODIFIERS,
  },
  {
    id: "subGroupCount",
    label: "Subgroup Count",
    type: "number",
    filterKey: "subGroupCountCriterion",
    modifiers: NON_NULL_NUMBER_MODIFIERS,
  },
  {
    id: "containingGroupCount",
    label: "Containing Group Count",
    type: "number",
    filterKey: "containingGroupCountCriterion",
    modifiers: NON_NULL_NUMBER_MODIFIERS,
  },
  {
    id: "tagCount",
