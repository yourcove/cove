...
import { X, Search, Pin, PinOff, Plus, Minus, Star, ArrowLeft, Film, Users, Workflow, ChevronDown, ChevronUp } from "lucide-react";
...
function FilterExpressionEditor({
  ...
  return (
    <FilterExpressionEditorView
      ...
      subjectLabel={subjectLabel}
      describeCondition={(filter) => formatExplanationNodeInline(explainExpressionLeaf(filter, criteria, ratingOptions, metadataServers))}
    />
  );
}
