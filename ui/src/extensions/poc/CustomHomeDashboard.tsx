  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      ...
      <div className="bg-card rounded-lg border border-border p-6">
        <h2 className="text-lg font-semibold text-foreground mb-3">How Page Override Works</h2>
        <div className="text-sm text-secondary space-y-2">
          <p>
            The <code className="bg-surface px-1 py-0.5 rounded">CustomHomeExtension</code> backend
            registers a <code className="bg-surface px-1 py-0.5 rounded">UIPageOverride</code> targeting
            the "home" page.
          </p>
          <p>
            The frontend <code className="bg-surface px-1 py-0.5 rounded">ExtensionLoader</code> resolves
            the override and the <code className="bg-surface px-1 py-0.5 rounded">App.tsx</code> router
