...
describe("filter criteria definitions", () => {
  ...
  it("keeps video filter labels and modifiers aligned with the supported UI", () => {
    ...
    expect(videoCriteriaById.get("playCount")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(videoCriteriaById.get("fileCount")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(videoCriteriaById.get("frameRate")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
  ...
  it("offers related-entity filters instead of specialized performer-favorite filters", () => {
    ...
    expect(PERFORMER_CRITERIA).toContainEqual(
      expect.objectContaining({
        id: "relatedVideos",
  ...
  it("keeps performer count and timestamp modifiers aligned with non-null backend semantics", () => {
    ...
    expect(performerCriteriaById.get("videoCount")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(performerCriteriaById.get("audioCount")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(performerCriteriaById.get("textCount")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(performerCriteriaById.get("studioCount")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(performerCriteriaById.get("imageCount")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(performerCriteriaById.get("galleryCount")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(performerCriteriaById.get("playCount")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(performerCriteriaById.get("likeCounter")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(performerCriteriaById.get("tagCount")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(performerCriteriaById.get("createdAt")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(performerCriteriaById.get("updatedAt")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
  ...
  it("keeps count-based tag, studio, gallery, image, and group criteria aligned with non-null backend semantics", () => {
    ...
    expect(tagCriteriaById.get("videoCount")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(tagCriteriaById.get("performerCount")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(tagCriteriaById.get("tagGroup")?.modifiers).toEqual(["INCLUDES", "EXCLUDES", "IS_NULL", "NOT_NULL"]);
    ...
    expect(tagCriteriaById.get("childCount")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(studioCriteriaById.get("videoCount")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(studioCriteriaById.get("galleryCount")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(studioCriteriaById.get("groupCount")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(galleryCriteriaById.get("tagCount")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(imageCriteriaById.get("performerCount")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(imageCriteriaById.get("tagCount")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(groupCriteriaById.get("videoCount")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
    ...
    expect(groupCriteriaById.get("tagCount")?.modifiers).toEqual([
      "EQUALS",
      "NOT_EQUALS",
      "GREATER_THAN",
      "LESS_THAN",
