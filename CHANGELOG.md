...
- An Unraid Docker template is published for `cove-app`. It maps appdata and media, accepts an external PostgreSQL/pgvector connection string, and optionally configures Intel, AMD, and NVIDIA transcoding.
